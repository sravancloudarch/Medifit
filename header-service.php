...
<head>
    ...
    <script type="text/javascript" src="js/revslider.jquery.themepunch.revolution.js"></script> <!-- Revolution Slider -->
	...
	<title>MEDFIT EQUIP UK LTD </title></head>
...
<div id="wrap">
    ...
    <header id="header">
    	...
    	<!-- begin logo -->
        <h1 id="logo"> <a href="index.php"><img src="images/logo.png" alt="Hirise Homes"></a> </h1>  
        <!-- end logo -->
