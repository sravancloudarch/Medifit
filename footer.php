 <!-- begin footer -->
    <footer id="footer">
        ...
        <div id="footer-featured">
            <div class="container clearfix">
                <div class="three-fourths">
                    ...
                    <p>Our process begins with knowing you and your requirement. Reach us soon for world class product.</p>
                </div>
        ...
        <div id="footer-top">
            <div class="container clearfix">
                <div class="one-fourth">
                    <div class="widget">
                        <h3>About</h3>
                                    Medfit Equip UK limited is your one stop solution to all of your Medical, Sports and Fitness procurement needs. Whether you need supplies, machinery or full equipment for your sports, fitness, hospitals and health facilities. </p>                    </div>
                
                </div>
                <div class="one-fourth">
                    <div class="widget twitter-widget">
                        <h3>Location</h3>
                        <div ><iframe width="200" height="200" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.maps.ie/create-google-map/map.php?width=200&amp;height=100&amp;hl=en&amp;q=71%20Cricklewood%20Broadway%2C%20London%20NW2%203JR%2C%20UK+(MEDFIT%20EQUIP%20UK%20LTD)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=A&amp;output=embed"></iframe><br /></div>
                    </div>
                </div>
                <div class="one-fourth">
                ...
                <div class="one-fourth column-last">
                    <div class="widget contact-info">
                        <h3>Contact Info</h3>
                        <div>
                            <p class="address"><strong>Address:</strong>MEDFIT EQUIP UK LTD, No:71 Cricklewood Broadway, LONDON, NW2 3JR.</p>
                            <p class="phone"><strong>Phone:</strong> 44 2038740279 </p>
                            <p class="phone"><strong>Phone:</strong> 44 2038741281</p>
                            <p class="email"><strong>Email:</strong> <a href="">medfixequipuk@gmail.com</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="footer-bottom">
            <div class="container clearfix">
                <div class="one-half">
                    <p>Copyright &copy; 2017  Created by <a href="">nighilvadakkan</a>.</p>
                </div>
